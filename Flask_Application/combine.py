...
def combine(probabilities_MRI,probabilities_Genes,gene_predicted_label,probabilities_Audio):
    ...
    if len(probabilities_Audio) == 0:
           ...
           print("MRI's model weights:",model_1_weight)
           print("Genes's model weights:",model_2_weight)
    ...
    if len(probabilities_Genes) == 0:
          for i in range(len(probabilities_MRI)):
                ...
                print("MRI's model weights:",model_1_weight)
                print("Audio's model weights:",model_3_weight)
    ...
    if len(probabilities_MRI) == 0:
           ...
           print("Genes's model weights:",round(model_2_weight,2))
           print("Audio's model weights:",round(model_3_weight,2))
           ...
           if gene_predicted_label =="CN":
                   ...
                   print("CN Combined Probability is:",round(array_combined_probabilities[1],2))
                   print("AD-MCI Combined Probability is:",round(array_combined_probabilities[0],2))
    ...
    if len(probabilities_MRI) != 0 and len(probabilities_Genes) != 0 and len(probabilities_Audio) != 0:
         ...
         print("MRI's model weights:",round(model_1_weight,2))
         print("Genes's model weights:",round(model_2_weight,2))
         print("Audio's model weights:",round(model_3_weight,2))
